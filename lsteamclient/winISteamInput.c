...
int8_t __thiscall winISteamInput_SteamInput005_Init(struct w_iface *_this, int8_t bExplicitlyCallRunFrame)
{
    ...
    struct ISteamInput_SteamInput005_GetSessionInputConfigurationSettings_params config_params =
    {
        .u_iface = _this->u_iface,
    };
    uint64_t native_handles[16] = {0};
...
uint16_t __thiscall winISteamInput_SteamInput005_GetSessionInputConfigurationSettings(struct w_iface *_this)
{
    ...
    params._ret = steaminput_xinput_get_session_configuration( params._ret );
    return params._ret;
}
...
int8_t __thiscall winISteamInput_SteamInput006_Init(struct w_iface *_this, int8_t bExplicitlyCallRunFrame)
{
    ...
    struct ISteamInput_SteamInput006_GetSessionInputConfigurationSettings_params config_params =
    {
        .u_iface = _this->u_iface,
    };
    uint64_t native_handles[16] = {0};
...
int8_t __thiscall winISteamInput_SteamInput007_Init(struct w_iface *_this, int8_t bExplicitlyCallRunFrame)
{
    ...
    struct ISteamInput_SteamInput007_GetSessionInputConfigurationSettings_params config_params =
    {
        .u_iface = _this->u_iface,
    };
    uint64_t native_handles[16] = {0};
